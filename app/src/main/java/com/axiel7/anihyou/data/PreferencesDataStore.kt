...
object PreferencesDataStore {
    ...
    val ANIME_REPEATING_LIST_STYLE_PREFERENCE_KEY = stringPreferencesKey("anime_repeating_list_style")
    ...
    val MANGA_REPEATING_LIST_STYLE_PREFERENCE_KEY = stringPreferencesKey("anime_repeating_list_style")
