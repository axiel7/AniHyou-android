                ...
                mutableUiState.update { state ->
                    ...
                    if (currentIndex != -1) {
                        ...
                        state.recommendations[currentIndex] = currentNode.copy(
                            rating = result.data.SaveRecommendation?.mediaRecommended?.rating ?: currentNode.rating,
                            userRating = result.data.SaveRecommendation?.mediaRecommended?.userRating ?: newRating
                        )
                    }
                    state
                }
