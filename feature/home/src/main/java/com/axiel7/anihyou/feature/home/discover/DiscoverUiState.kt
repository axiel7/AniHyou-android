...
data class DiscoverUiState(
    ...
    val popularAnime: SnapshotStateList<MediaSortedQuery.Medium> = mutableStateListOf(),
    val recommendations: SnapshotStateList<MediaSortedQuery.Medium> = mutableStateListOf(),
